...
import avatar from '../avator2.png';
      ...
      <div className='absolute inset-0 top-[120px] max-w-7xl mx-auto px-6 sm:px-16 flex flex-row items-start gap-5'>
        ...
        <div className="flex-1 flex flex-col md:flex-row items-start justify-between">
          <div className="md:max-w-[60%]">
            ...
            >
              Computer Science student at NIT Rourkela with a 
              passion for solving complex problems through code.
              Specialized in DSA, machine learning, and full-stack development.
            </motion.p>
